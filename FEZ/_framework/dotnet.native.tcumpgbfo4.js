...
var ASM_CONSTS = {
 ...
 1137049: () => Module["SDL3"].audioContext.sampleRate,
 1137100: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1143105: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1143164: ($0, $1, $2, $3, $4) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 1145721: ($0, $1, $2) => {
  ...
  GROWABLE_HEAP_U8().set(imgrgba, rgba);
  return 1;
 },
 1146099: () => {
 ...
 1150553: () => Module["SDL3"]["mouse_x"],
 1150591: () => Module["SDL3"]["mouse_y"],
 1150629: $0 => Module["SDL3"]["mouse_buttons"][$0],
 1150677: $0 => {
  var data = $0;
  ...
  if (SDL3.makePointerEventCStruct === undefined) {
   SDL3.makePointerEventCStruct = function(left, top, event) {
    ...
    if (ptr != 0) {
     ...
     GROWABLE_HEAP_I32()[idx++] = (event.type == "pointerdown") ? 1 : 0;
     GROWABLE_HEAP_F32()[idx++] = event.movementX;
     GROWABLE_HEAP_F32()[idx++] = event.movementY;
     GROWABLE_HEAP_F32()[idx++] = event.clientX - left;
     GROWABLE_HEAP_F32()[idx++] = event.clientY - top;
     if (ptrtype == 3) {
 ...
 1152921: () => document.body.clientWidth,
 1152959: () => document.body.clientHeight,
 1152998: () => window.innerWidth,
 1153028: () => window.innerHeight,
 1153059: () => window.outerWidth,
 1153089: () => window.outerHeight,
 1153120: () => window.pageXOffset,
 1153151: () => window.pageYOffset,
 1153182: ($0, $1) => {
 ...
 1158963: () => window.innerWidth,
 1158993: () => window.innerHeight,
 1159024: $0 => {
 ...
 1159133: ($0, $1) => {
  var pngData = GROWABLE_HEAP_U8().buffer instanceof ArrayBuffer ? GROWABLE_HEAP_U8().subarray($0, $0 + $1) : GROWABLE_HEAP_U8().slice($0, $0 + $1);
 ...
 1159700: () => window.innerWidth,
 1159730: () => window.innerHeight,
 1159761: $0 => {
...
var findCanvasEventTarget = target => {
 ...
 return GL.offscreenCanvases[target.substr(1)] ||  (target == "canvas" && Object.values(GL.offscreenCanvases)[0]) ||  (typeof document != "undefined" && document.querySelector(target));
};
...
var _CallSDLEmscriptenMainFunction = Module["_CallSDLEmscriptenMainFunction"] = (a0, a1, a2) => (_CallSDLEmscriptenMainFunction = Module["_CallSDLEmscriptenMainFunction"] = wasmExports["CallSDLEmscriptenMainFunction"])(a0, a1, a2);
